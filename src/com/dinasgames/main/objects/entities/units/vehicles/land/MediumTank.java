...
public class MediumTank extends LandVehicle implements RenderEvents, SceneEvents {
    ...
    public void onRenderAdd(Renderer r) {
        ...
        mShapeTurret.setOrigin(0.f+(mWidth/10), mShapeTurret.getHeight() / 2.f);
...
//    }
    ...
    public int getTypeID() {
        return super.getTypeID() | GameObjectType.MediumTank.getID();
    }
