...
public class IFV extends LandVehicle implements RenderEvents, SceneEvents {
     ...
     * The gun end
     */
    protected RectangleShape mShapeDoors;
    ...
    public void onRenderUpdate(Renderer r) {
        ...
        mShapeDoors.setPosition(mX, mY);
        mShapeDoors.setRotation(mRotation);
    ...
    public int getTypeID() {
        return super.getTypeID() | GameObjectType.IFV.getID();
    }
