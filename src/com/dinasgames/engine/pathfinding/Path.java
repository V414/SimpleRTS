package com.dinasgames.engine.pathfinding;
...
public class Path extends Renderable {
  ...
  protected boolean mUpdateNeeded;
  ...
  public void setColor(Color color) {
    ...
    if(mColor == null && color == null) {
      return;
    }
    
    if(mColor != null && color.equals(mColor)) {
      return;
    }
  ...
  protected void redrawPath() {
    ...
    // Resize our vertex cache
    mVerts.resize(steps.size());
    ...
    for(Object obj : steps) {
      ...
      Step step = (Step)obj;
      mVerts.setPosition(i, step.getX(), step.getY());
  ...
  public void draw(RenderTarget target, RenderStates states) {
    ...
    states.transform.multiply(mTransform);
